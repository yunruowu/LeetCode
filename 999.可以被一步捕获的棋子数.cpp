...
public:
    ...
    int numRookCaptures(vector<vector<char>>& board) {
        ...
        int ans = 0;
        for (int i = R_Pos.x-1; i>=0; i--)
        {
            if(board[i][R_Pos.y]=='B'){
                break;
            }
            if(board[i][R_Pos.y]=='p'){
                ans++;
                break;
            }
        }
        for (int i = R_Pos.x+1; i<8; i++)
        {
            if(board[i][R_Pos.y]=='B'){
                break;
            }
        ...
        for (int i = R_Pos.y+1; i<8; i++)
        {
            
            if(board[R_Pos.x][i]=='p'){
                ans++;
                break;
            }
            if(board[R_Pos.x][i]=='B'){
                break;
            }
        }
        for (int i = R_Pos.y-1; i>=0; i--)
        {
            if(board[R_Pos.x][i]=='B'){
                break;
            }
