...
public class WifiAdmin {
  ...
  public void openWifi(Context context) {
    if (!mWifiManager.isWifiEnabled()) {
      ...
      Toast
          .makeText(context, "亲，Wifi正在开启，不用再开了", Toast.LENGTH_SHORT)
          .show();
    } else {
  ...
  public void closeWifi(Context context) {
    if (mWifiManager.isWifiEnabled()) {
      ...
      Toast
          .makeText(context, "亲，Wifi已经关闭，不用再关了", Toast.LENGTH_SHORT)
          .show();
    } else if (mWifiManager.getWifiState() == 0) {
      Toast
          .makeText(context, "亲，Wifi正在关闭，不用再关了", Toast.LENGTH_SHORT)
          .show();
    } else {
  ...
  public void startScan(Context context) {
    ...
    if (mWifiList == null) {
      if (mWifiManager.getWifiState() == 3) {
        ...
        Toast
            .makeText(context, "WiFi正在开启，请稍后重新点击扫描",
                      Toast.LENGTH_SHORT)
            .show();
      } else {
        Toast.makeText(context, "WiFi没有开启，无法扫描", Toast.LENGTH_SHORT)
            .show();
      }
    }
  }
  ...
  // 得到网络列表
  public List<ScanResult> getWifiList() { return mWifiList; }
